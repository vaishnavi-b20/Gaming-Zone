    ...
    return (
        <div className='relative size-full'>
            ...
            <div className='relative z-10 flex size-full flex-col justify-between p-5 text-blue-50 '>
                <div>
                    <h1 className="uppercase md:text-6xl text-4xl font-black font-zentry special-font" style={{ fontFamily: "'Zentry', serif" }}>{title}</h1>
                    {description && (
  ...
  return (
    <section className='bg-black pb-52'>
        ...
        <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
            ...
            <BentoTilt className='relative col-span-2 overflow-hidden rounded-md transition-transform duration-300 ease-out row-span-1 me-25  md:col-span-1 md:me-0'>
                <BentoCard 
            ...
            <BentoTilt className='relative col-span-1 row-span-1 overflow-hidden rounded-md transition-transform duration-300 ease-out '>
                <div className='flex size-full flex-col justify-between bg-violet-300 p-5'>
                    <h1 className='uppercase md:text-6xl text-4xl font-black special-font max-w-64 text-black' style={{ fontFamily: "'Zentry', serif" }}>M<b>o</b>re co<b>m</b>ing s<b>o</b>on!</h1>
